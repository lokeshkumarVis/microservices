...
def index():
	return 'This is Database Service home'#render_template('index.html')
...
def database():
	if request.method == 'POST':
		...
		address={'sent_address':req_data["address"], 'recieved_address':req_data["address"],'Service_Called':' property service'}
